...
import com.dcais.aggra.converter.StringConverter;
import com.dcais.aggra.request.DynamicRequest;
import com.dcais.aggra.test.entity.StringIds;
import com.dcais.aggra.test.request.TestRequest;
import com.dcais.aggra.test.request.TestRmiRequest;
import com.dcais.aggra.test.request.TestRmiRequest2;
import com.dcais.aggra.test.result.ReqestPage;
import com.dcais.aggra.test.result.Result;
import com.dcais.aggra.test.result.ReturnInfo;
import com.dcais.aggra.test.result.UploadFileInfo;
import com.dcais.aggra.test.result.tabs.TopicTabsQueryView;
import com.dcais.aggra.test.result.tabs.TopicTabsView;
...
//    private Test2Request test2Request;
  ...
  public void testReturnVoid() {
    ...
    testRequest.testReturnVoidWithSigleParams(complexPara, "中尉1", "XMLHttpRequest");
  }
