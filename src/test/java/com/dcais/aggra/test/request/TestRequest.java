...
public interface TestRequest {
  ...
  @ReqHead(keys = {"Method-Head-1", "Method-Head-2"}, values = {"MethodHead1", "MethodHead2"})
  void testReturnVoidWithSigleParams(@ReqParam Map<String, Object> aComplexPara, @ReqSecure @ReqParam("like") String p3, @ReqHead("X-Requested-With") String xRequestWith);
